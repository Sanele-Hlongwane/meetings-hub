...
const FAQ = () => {
  return (
    <div className="p-8 bg-gradient-to-br from-gray-900 via-gray-800 to-black dark:bg-gradient-to-br dark:from-gray-100 via-gray-200 to-white  py-24 text-white dark:text-black">
