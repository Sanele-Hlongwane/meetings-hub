...
const AboutUs = () => {
  return (
    <div className="py-24 bg-bg-dark-1 dark:bg-dark-1 text-white dark:text-white">
      ...
      <section className="mb-8 py-8 px-6 rounded-lg shadow-lg w-full max-w-screen-sm md:max-w-screen-md mx-auto transition-transform transform hover:scale-105 duration-300 border-2 border-blue-500 bg-dark-1 dark:bg-dark-1 text-white dark:text-white">
      ...
      <section className="bg-dark-1 dark:bg-dark-1 py-8 px-6 rounded-lg shadow-lg w-full max-w-screen-sm md:max-w-screen-md mx-auto transition-transform transform hover:scale-105 duration-300 border-2 border-blue-500 text-white dark:text-white">
