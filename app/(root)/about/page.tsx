...
const AboutUs = () => {
  return (
    <div className="py-24 bg-bg-dark-1 dark:bg-dark-1 text-white dark:text-white">
      ...
      <section className="mb-8 py-8 px-6 rounded-lg shadow-lg w-full max-w-screen-sm md:max-w-screen-md mx-auto transition-transform transform hover:scale-105 duration-300 border-2 border-blue-500 bg-white dark:bg-black text-gray-700 dark:text-gray-300">
      ...
      <section className="mb-8 py-8 px-6 rounded-lg shadow-lg w-full max-w-screen-sm md:max-w-screen-md mx-auto transition-transform transform hover:scale-105 duration-300 border-2 border-blue-500 bg-white dark:bg-black text-gray-700 dark:text-gray-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-medium text-gray-100 dark:text-gray-100">John Doe</h3>
            <p className="text-sm sm:text-base text-gray-400 dark:text-gray-400">Founder & CEO</p>
            <p className="text-sm sm:text-base mt-2 text-gray-400 dark:text-gray-400">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-medium text-gray-100 dark:text-gray-100">Jane Smith</h3>
            <p className="text-sm sm:text-base text-gray-400 dark:text-gray-400">Chief Operating Officer</p>
            <p className="text-sm sm:text-base mt-2 text-gray-400 dark:text-gray-400">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-medium text-gray-100 dark:text-gray-100">Alice Johnson</h3>
            <p className="text-sm sm:text-base text-gray-400 dark:text-gray-400">Chief Marketing Officer</p>
            <p className="text-sm sm:text-base mt-2 text-gray-400 dark:text-gray-400">
      ...
      <section className="bg-white dark:bg-black py-8 px-6 rounded-lg shadow-lg w-full max-w-screen-sm md:max-w-screen-md mx-auto transition-transform transform hover:scale-105 duration-300 border-2 border-blue-500 text-gray-700 dark:text-gray-300">
