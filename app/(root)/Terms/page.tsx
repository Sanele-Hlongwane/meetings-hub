...
const TermsAndConditions = () => {
  const sections = [
    ...
    { id: 'user-conduct', title: 'User Conduct', content: 'You agree to use our platform only for lawful purposes and in accordance with these terms. You agree not to use our platform.' },
    ...
    { id: 'contact', title: 'Contact Information', content: 'If you have any questions about these terms and conditions, please contact us at <a href="mailto:contact@eaglesring.com" className="text-blue-600 dark:text-blue-400 hover:underline">contact@eaglesring.com</a>.' },
  ];
