...
interface SignUpFormProps {
  signUpWithEmail: ({emailAddress, password, role}:{emailAddress: string, password: string, role: string}) => void
  clerkError: string
}
        ...
        <div className="p-6 md:p-8">
          ...
          <form
            onSubmit={(e) => {
              ...
              signUpWithEmail({emailAddress: email, password: password, role: role});
            }}
          >
            <input
              name="email"
            ...
            <select
              name="role"
              className="block w-full mb-3 text-sm font-light bg-transparent border-0 border-b-2 h-37 border-slate-600 text-white caret-slate-700 focus:border-white"
              required
            >
